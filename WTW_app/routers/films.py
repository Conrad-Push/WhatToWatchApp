...
def get_film_details(film_id:int) -> tp.Optional[FilmModel]:
    ...
    _film_details: tp.Optional[FilmModel] = films_repository.get_film_details(film_id=film_id)
...
def modify_film_details(film_id: int, film_payload: PatchFilmModel) -> tp.Optional[FilmModel]:
    films_repository: IFilmsRepository = films_in_memory
...
@films_router.delete("/{film_id:int}", response_model=FilmModel, responses={404: {"description": "Film for given film_id not found."}})
