...
from WTW_app.postgreSQL.dependencies import get_database_repository

postgres_database_router = APIRouter(
    prefix="/postgresql/database",
    tags=["Database - PostgreSQL"],
)


@postgres_database_router.get("/status", response_model=DatabaseInfoResponse)
...
@postgres_database_router.get("/tables/restart", response_model=DatabaseInfoResponse)
...
@postgres_database_router.post("/data/generate", response_model=DataGenerationResponse)
def generate_data(
...
@postgres_database_router.post("/data/scrap", response_model=DataScrappingResponse)
def scrap_data(
