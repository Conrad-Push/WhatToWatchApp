...
from WTW_app.postgreSQL.dependencies import get_films_repository

postgres_films_router = APIRouter(
    prefix="/postgresql/films",
    tags=["Films - PostgreSQL"],
)


@postgres_films_router.get(
    "/",
